...
(function () {
  ...
  async function init(container, callbacks) {
      ...
      <section class="catalog" aria-label="Выбор автомобиля">
        <header class="catalog-topbar">
          ...
          <nav class="catalog-topbar-actions" aria-label="Ссылки проекта">
            ...
            <a class="catalog-topbar-link catalog-topbar-boosty" href="https://boosty.to/magic_sqd" target="_blank" rel="noopener">Boosty</a>
            <a class="catalog-topbar-link" href="https://github.com/torisar93/magic_sqd" target="_blank" rel="noopener">GitHub</a>
    ...
    searchEl.addEventListener("input", renderCurrentStep);
  ...
  function renderCatalog(view) {
    ...
    visibleItems.forEach((item, index) => gridEl.appendChild(createCard(item, index)));
  }
  ...
  window.mainPicker = {
    ...
    showStartupLoading, setStartupProgress, hideStartupLoading,
  };
})();
