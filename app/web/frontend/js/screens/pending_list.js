...
// по себе при старте — до первого явного входа в админку (см.
// admin-login-btn/adminDialog в app.js) submissions_list() почти всегда
// вернёт "Сначала войдите...", и дёргать это молча на каждом запуске
// приложения было бы просто раздражающим шумом — ждём клика "Обновить"
// (или успешного логина где-то ещё в программе).
(function () {
