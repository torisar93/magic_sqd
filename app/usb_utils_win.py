"""Windows-реализация usb_utils — список дисков и безопасное форматирование
через WinAPI/PowerShell. См. usb_utils.py (диспетчер по sys.platform) и
usb_utils_mac.py (реализация через diskutil)."""
