"""
Мастер "Установка по этапам..." — все пункты старого меню Start Preface.bat
как отдельные кнопки. Подключение по Wi-Fi ADB выполняется заново в
начале каждого этапа.
"""
import sys
...
STAGES = [
    {
        "type": "adb",
        "title": "Приложение «Настройки» для Preface",
        "description": "Переустановка Settings.apk (пункт 1 старого меню).",
        "run": _with_connect(m.install_settings_app),
    },
    {
        "type": "apps",
